...
[Training_X, Training_Y, Validation_X, Validation_Y] = Data_Generation.Data_generation_offline_version_Alternative_Pattern(Training_set_ratio, SNR_range, Num_of_frame_each_SNR);
